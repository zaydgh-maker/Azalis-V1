      ...
      <Container>
        <div className="py-12">
          ...
          <div className="text-center mb-8">
            <h3 className="font-serif text-xl font-light text-azalis-green mb-2" style={{ letterSpacing: '0.2em' }}>
              AZALIS
            </h3>
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <a
              href="https://wa.me/212778987933"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-azalis-green hover:text-azalis-green-hover transition-colors"
            >
            ...
            <a
              href="https://www.instagram.com/azalis.care"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-azalis-green hover:text-azalis-green-hover transition-colors"
            >
